...
public class Widget4 extends AppWidgetProvider {
	...
	private final static String TAG = "Widget4";
	...
	static void updateWidget(Context context, AppWidgetManager appWidgetManager, SharedPreferences sp, int widgetID) {
		...
		RemoteViews widgetView = new RemoteViews(context.getPackageName(), R.layout.widget_4);
	    ...
	    try {  
	        ...
	        widgetView.setTextViewText(R.id.w4noSmokeDays, String.format(res.getString(R.string.w4_no_smoke_days), daysCount, Utils.getDaysLabel(context, daysCount)));
	    ...
	    widgetView.setTextViewText(R.id.w4noSmokePrice, String.format(res.getString(R.string.w4_no_smoke_price), price*daysCount));
