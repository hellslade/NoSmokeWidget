...
public class Widget5 extends AppWidgetProvider {

	private final static String TAG = "Widget5";
	...
	static void updateWidget(Context context, AppWidgetManager appWidgetManager, SharedPreferences sp, int widgetID) {
		...
		RemoteViews widgetView = new RemoteViews(context.getPackageName(), R.layout.widget_5);
	    ...
	    try {  
	        ...
	        widgetView.setTextViewText(R.id.w5noSmokeDays, String.format(res.getString(R.string.w5_no_smoke_days), daysCount, Utils.getDaysLabel(context, daysCount)));
	    ...
	    widgetView.setTextViewText(R.id.w5noSmokeCount, String.format(res.getString(R.string.w5_no_smoke_count), count*daysCount));
